...
class Donatur_terverifikasi_model extends MY_Model{
    ...
    $this->datatables->add_column('action',
                                  // '<a href="'.site_url("backend/donatur_terverifikasi/detail/$1").'" id="update" class="badge badge-primary p-a-5 text-white" data-toggle="tooltip" data-placement="bottom" title="Detail">Detail</a>
