      ...
      <div class="col-lg-12 mx-auto">
        <div class="card">
            <div class="card-header">
              ...
              <a href="<?=site_url('backend/donatur_menunggu_verifikasi/add')?>" style="position:absolute;right:10px;" class="btn btn-sm btn-primary btn-xs btn-icon-right">Tambah <i class="fa fa-plus"></i></a>
            </div>
...
$(document).ready(function() {
      $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      {
        ...
        var t = $("#table").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?=base_url()?>backend/donatur_menunggu_verifikasi/json", "type": "POST"},
            columns: [
                {
                    "data": "id_donatur",
                    "orderable": false
